...
public:
    ...
    {
        GUIWindow->setWindowTitle(QApplication::translate("GUIWindow", "GUIBot", 0));
        actionRefresh->setText(QApplication::translate("GUIWindow", "Refresh", 0));
        button_connect->setText(QApplication::translate("GUIWindow", "Connect", 0));
        menuOptions->setTitle(QApplication::translate("GUIWindow", "Options", 0));
        menuPort_COM->setTitle(QApplication::translate("GUIWindow", "Port COM", 0));
    } // retranslateUi
